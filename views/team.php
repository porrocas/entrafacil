  ...
  <div class="jumbotron">
      <div class="container">
          <h1 class="display-3">Nuestro equipo!</h1>
          <p class="text-dark">Somos una start-up Colombiana, liderada por jóvenes que cursan una carrera para ser profesional, donde nos gustan las fiestas y los buenos eventos, en este proceso nos dimos cuenta que el proceso para entrar a los eventos y logística es poco tedioso y por eso decidimos mejorarlo.</p>
          <p><a class="btn btn-primary btn-lg" href="equipo.php" role="button">Saber mas &raquo;</a></p>
      </div>
  </div>
      ...
      <div class="row aling-vertical-team">
          <div class=" cont-my-team col-md-4">
            <div class="img-team-perfil">
                <img src="./img/p2.jpeg" alt="" class="img-fluid">
            </div>
            <small class="text-muted">CMO | Chief Marketing Officer</small>
              ...
              <p><a class="btn btn-secondary" href="equipo.php?team=ValentinaCaballero" role="button">Conocer &raquo;</a></p>
          </div>
          <div class=" cont-my-team col-md-4">
            <div class="img-team-perfil">
                <img src="./img/p0.jpeg" alt="" class="img-fluid">
            </div>
            <small class="text-muted">CEO | Chief Executive Officer</small>
              ...
              <p><a class="btn btn-secondary" href="equipo.php?team=SebastianCastro" role="button">Conocer &raquo;</a></p>
          </div>
          <div class=" cont-my-team col-md-4">
            <div class="img-team-perfil">
            ...
            <small class="text-muted">CTO | Chief Technology Officer</small>
              ...
              <br>
              <p><a class="btn btn-secondary" href="equipo.php?team=DanielMateus" role="button">Conocer &raquo;</a></p>
          </div>
      </div>
